...
loadProdDataFromFile                    = false;    % true or false
...
producers(2).investInput.D = set_D;     % Decline curve parameter 1 (initial decline rate)
producers(2).investInput.b = set_b;     % Decline curve parameter 2 (curvature of line)
producers(2).investInput.q0 = set_q01;  %[bbl/day] Initial production rate.
...
producers(5).investInput.D = set_D;     % Decline curve parameter 1 (initial decline rate)
producers(5).investInput.b = set_b;     % Decline curve parameter 2 (curvature of line)
producers(5).investInput.q0 = set_q01;  %[bbl/day] Initial production rate.
