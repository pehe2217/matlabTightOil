...
if(loadOilPriceFromFile)
    f = 'RWTCm.xls';
    sheet    = 'Data 1';
    range    = 'A292:B370';  % from jan 2010 TO dec 2015
...
if(loadRigDataFromFile)
    ...
    range    = 'B39:B117';   % from jan 2010 TO July 2016
...
if(loadWellsPerRigRateFromFile)
    ...
    sheet    = 'Eagle Ford Region';
    range    = 'L39:L117';   % from jan 2010 TO July 2016
...
producers(1).investInput.distribution_D  = distribution_D;
producers(1).investInput.drillCost = 2.3e6;                        %[USD] One-time drilling cost
producers(1).investInput.comCost =   2.3e6;                          %[USD] One-time completion cost
producers(1).investInput.royaltiesAndTaxes = 0.12;               %[percentage]
producers(1).investInput.operatingCost = 10;   
producers(1).NPVestimatorInput.drillCost = 2.3e6;                        %[USD] One-time drilling cost
producers(1).NPVestimatorInput.comCost =   2.3e6;                          %[USD] One-time completion cost
producers(1).NPVestimatorInput.royaltiesAndTaxes = 0.12;               %[percentage]
producers(1).NPVestimatorInput.operatingCost = 10;   
